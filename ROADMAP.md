...
## 0.3 — More media sources

- Animated GIF and image-sequence adapters
- Livestream sampling with rolling alerts
- Batch and URL-based ingestion
- Hardware-accelerated decoding

## 1.0 — Publishing integrations

- Browser extension for pre-publish checks
- CMS and CI integrations
- Webhooks and stable versioned API clients
